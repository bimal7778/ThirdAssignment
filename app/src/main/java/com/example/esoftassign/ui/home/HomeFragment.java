...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if(DashboardActivity.st.isEmpty()) {
            DashboardActivity.st.add(new Student("Bimal Godar", "Male", "22", "Greenland"));
            DashboardActivity.st.add(new Student("Aisha Takiya", "Female", "20", "Baneshwor"));
